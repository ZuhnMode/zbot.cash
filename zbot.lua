...
local cfglocation = "zbot_cash/cfg/cbro"
makefolder("zbot_cash/cfg/cbro")
...
function library:SaveConfig(cfg)
	...
	writefile(cfglocation..cfg..".cash", game:GetService("HttpService"):JSONEncode(copy))
end
...
makefolder("zbot_cash/cfg/cbro/lua")

local allluas = {}

for _,lua in pairs(listfiles("zbot_cash/cfg/cbro/lua")) do
	local luaname = string.gsub(lua, "zbot_cash/cfg/cbro/lua\\", "")
	table.insert(allluas, luaname)
end

RunService.RenderStepped:Wait()

local gui = library:New("zbot.cash")
...
aimbot:Element("Dropdown", "penetration changer", {options = {"0.01", "0.05", "0.1", "1", "10", "1000"}})
...
exploits:Element("Toggle","clear weapons",{},function(tbl)
	while values.rage.exploits["clear weapons"].Toggle == true do
		wait(1)
...
world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "1nn", "oni-chan", "Bonk", "Welcome", "Semi", "osu", "Tf2", "Tf2 pan", "M55solix", "Slap","Minecraft", "jojo", "vibe", "supersmash", "epic", "retro", "quek", "Dababy"}})  
world:Element("Slider", "sound volume", {min = 1, max = 5, default = 3})
world:Element("Dropdown", "skybox", {options = {"none", "nebula", "Red-Mountain", "vaporwave", "clouds", "twilight", "Cloudy Skies", "Dark blue", "Pink Daylight", "Night", "Space", "pink vision", "animeskybox", "Alien Red", "Counter Strike City", "Dark City", "Earth", "Mountains", "Old Skybox", "Red Sky", "Red Sky", "Wasteland", "Bobux Generator", "Blue Sky", "Green Sky", "Red Sky"}}, function(tbl)  
...
local noclip = misc:Sector("noclip", "Right")
			...
			if tbl.Toggle then
				while values.misc.chat["chat spam"].Toggle do
					game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
						values.misc.chat.type.Dropdown == "Averagelol" and "Hi you stupid and get tap rlly stop crying i good like you ohh get Cuteware pls i love it okay????" or values.misc.chat.type.Dropdown == "Toggle" and "Toggle ur -md kid." or values.misc.chat.type.Dropdown == "zbot best" and "zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$ zbot.cash is the best$$$" or values.misc.chat.type.Dropdown == "Aww" and "Aw.. why did you die kid? Toggle? Toggle? Toggle?" or values.misc.chat.type.Dropdown == "nice config" and "Dayum, that's a nice config btw" or values.misc.chat.type.Dropdown == "zbot.cash2" and "I'm using zbot.cash$$$" or values.misc.chat.type.Dropdown == "Good" and "Get Good, get zbot.cash. Kid." or values.misc.chat.type.Dropdown == "Bully" and "Your dad says: I likes Femboys and sucks dick like a massive chunk of ass." or values.misc.chat.type.Dropdown == "Mad" and "Hey kid, You mad? Just get zbot.cash today!" or values.misc.chat.type.Dropdown == "You died.." and "HAHHA YOU JUST FUCKING DIED TO ZBOT.CASH, THATS FUCKING EMBARASSING" or values.misc.chat.type.Dropdown == "Cuteware.xyz" and "cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware!" or "cuteware.xyz" or "$$$" or "1 sit nn 1 sit nn 1 sit nn 1 sit nn" or "Get Good, get cuteware.xyz",
						false,
						"Innocent",
						false,
						true
...
chat:Element("Dropdown", "type", {options = {"Averagelol", "Toggle", "zbot best", "Aww", "nice config", "zbot.cash2", "Good", "Bully", "Mad", "Bully2", "Cuteware.xyz"}})
							...
							if Client.gun:FindFirstChild("Melee") and values.rage.aimbot["knifebot"].Toggle then
								...
								for _,Hitbox in ipairs(Hitboxes) do
									...
									if values.rage.aimbot["automatic penetration"].Toggle then
										...
										local Penetration = Client.gun.Penetration.Value * values.rage.aimbot["penetration changer"].Dropdown == "0.01" and 0.01 or values.rage.aimbot["penetration changer"].Dropdown == "0.05" and 0.05 or values.rage.aimbot["penetration changer"].Dropdown == "0.1" and 0.1 or values.rage.aimbot["penetration changer"].Dropdown == "1" and 1 or values.rage.aimbot["penetration changer"].Dropdown == "1000" and 1000
											...
											if #Hits == 0 then
												...
												if Damage >= Stats["minimum damage"].Slider then
													...
													if values.rage.aimbot["automatic fire"].Dropdown == "standard" then
														...
														if values.rage.exploits["five tap"].Toggle and values.rage.exploits["five tap"].Active then
															Client.firebullet()
															Client.firebullet()
															Client.firebullet()
															Client.firebullet()
												...
												local penetration = values.rage.aimbot["penetration changer"].Dropdown == "0.01" and 0.01 or values.rage.aimbot["penetration changer"].Dropdown == "0.05" and 0.05 or values.rage.aimbot["penetration changer"].Dropdown == "0.1" and 0.1 or values.rage.aimbot["penetration changer"].Dropdown == "1" and 1 or values.rage.aimbot["penetration changer"].Dropdown == "1000" and 1000
												local limit = 0
												local dmgmodifier = values.rage.aimbot["penetration changer"].Dropdown == "0.01" and 0.01 or values.rage.aimbot["penetration changer"].Dropdown == "0.05" and 0.05 or values.rage.aimbot["penetration changer"].Dropdown == "0.1" and 0.1 or values.rage.aimbot["penetration changer"].Dropdown == "1" and 1 or values.rage.aimbot["penetration changer"].Dropdown == "1000" and 1000
												for i = 1, #Hits do
													local data = Hits[i]
													local part = data["Hit"]
													local pos = data["Position"]
													local modifier = values.rage.aimbot["penetration changer"].Dropdown == "0.01" and 0.01 or values.rage.aimbot["penetration changer"].Dropdown == "0.05" and 0.05 or values.rage.aimbot["penetration changer"].Dropdown == "0.1" and 0.1 or values.rage.aimbot["penetration changer"].Dropdown == "1" and 1 or values.rage.aimbot["penetration changer"].Dropdown == "1000" and 1000
													...
													dmgmodifier = values.rage.aimbot["penetration changer"].Dropdown == "0.01" and 0.01 or values.rage.aimbot["penetration changer"].Dropdown == "0.05" and 0.05 or values.rage.aimbot["penetration changer"].Dropdown == "0.1" and 0.1 or values.rage.aimbot["penetration changer"].Dropdown == "1" and 1 or values.rage.aimbot["penetration changer"].Dropdown == "1000" and 1000 - limit / penetration
												end
...
LocalPlayer.Additionals.TotalDamage:GetPropertyChangedSignal("Value"):Connect(function(current)
	...
	local sound = Instance.new("Sound")
			...
			sound.SoundId =
				...
				values.visuals.world.hitsound.Dropdown == "1nn" and "rbxassetid://7349055654" or
				values.visuals.world.hitsound.Dropdown == "Welcome" and "rbxassetid://5149595745" or "rbxassetid://5447626464" or
				values.visuals.world.hitsound.Dropdown == "oni-chan" and "rbxassetid://130822574" or
				values.visuals.world.hitsound.Dropdown == "Bonk" and "rbxassetid://3765689841" or
				values.visuals.world.hitsound.Dropdown == "cod" and "rbxassetid://5447626464" or
				values.visuals.world.hitsound.Dropdown =="Semi" and "rbxassetid://7791675603" or
				...
				values.visuals.world.hitsound.Dropdown == "dababy" and "rbxassetid://6559380085" or
				values.visuals.world.hitsound.Dropdown == "baimware" and "rbxassetid://6607339542" or
				"rbxassetid://6607204501"
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)
	...
	if values.misc.chat["kill say"].Toggle then
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "looks like you don't own zbot.cash, hmm", false, "Innocent", false, true)
	end
end)
